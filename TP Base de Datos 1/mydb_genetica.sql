...
CREATE TABLE `genetica` (
  ...
  KEY `fk_genetica_cabaña1_idx` (`cabaña_cuit`),
  CONSTRAINT `fk_genetica_cabaña1` FOREIGN KEY (`cabaña_cuit`) REFERENCES `cabaña` (`cuit`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-10-09 17:21:40
